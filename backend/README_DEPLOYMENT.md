...
DataForge supports local SQLite storage and Postgres repository/queue code. Local SQLite tests pass in the safe backend suite. Postgres repository and queue tests passed locally with Docker/testcontainers: `1883 passed, 28 skipped in 129.55s`.
