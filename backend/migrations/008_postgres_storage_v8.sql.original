...
\restrict fRKAyhUraWQwVaATmxbYMFspXTvDR27nZM2IShtu4LmwPtevKjM07DEsQblPrmN
...
ALTER TABLE public.idempotency_keys OWNER TO dataforge;
...
ALTER TABLE public.job_events OWNER TO dataforge;
...
ALTER SEQUENCE public.job_events_event_id_seq OWNER TO dataforge;
...
ALTER TABLE public.job_results OWNER TO dataforge;
...
ALTER TABLE public.jobs OWNER TO dataforge;

--
-- Name: queue_schema_version; Type: TABLE; Schema: public; Owner: dataforge
--

CREATE TABLE public.queue_schema_version (
    id integer NOT NULL,
...
ALTER TABLE public.queue_schema_version OWNER TO dataforge;

--
-- Name: queue_task_history; Type: TABLE; Schema: public; Owner: dataforge
--

CREATE TABLE public.queue_task_history (
    id text NOT NULL,
    type text NOT NULL,
...
ALTER TABLE public.queue_task_history OWNER TO dataforge;
...
ALTER TABLE public.queue_tasks OWNER TO dataforge;
...
ALTER TABLE public.rate_limits OWNER TO dataforge;
...
ALTER TABLE public.recycle_bin OWNER TO dataforge;
...
ALTER TABLE public.schema_version OWNER TO dataforge;
...
ALTER TABLE public.worker_heartbeats OWNER TO dataforge;
...
ALTER TABLE public.world_state OWNER TO dataforge;
...
CREATE INDEX idx_job_events_job_id ON public.job_events USING btree (job_id, event_id);
...
CREATE INDEX idx_queue_task_history_finished ON public.queue_task_history USING btree (finished_at DESC);
...
CREATE INDEX idx_queue_task_history_type ON public.queue_task_history USING btree (type);
...
CREATE INDEX idx_queue_tasks_scheduled ON public.queue_tasks USING btree (scheduled_at);
...
CREATE INDEX idx_queue_tasks_status_priority ON public.queue_tasks USING btree (status, priority);
...
CREATE INDEX idx_rate_limits_key_ts ON public.rate_limits USING btree (key, "timestamp");
...
CREATE INDEX idx_recycle_bin_created_at ON public.recycle_bin USING btree (created_at DESC);
...
\unrestrict fRKAyhUraWQwVaATmxbYMFspXTvDR27nZM2IShtu4LmwPtevKjM07DEsQblPrmN
