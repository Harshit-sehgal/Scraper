...
SITES: list[SiteTest] = [
    ...
    SiteTest(
        ...
        schema=[SchemaField(name="data", field_type=FieldType.STRING, description="", required=False)],
        min_expected=0,
    ),
    SiteTest(
    ...
    SiteTest(
        ...
        schema=[
            ...
            SchemaField(name="body", field_type=FieldType.STRING, description="", required=False),
        ],
        min_expected=0,
    ),
]
