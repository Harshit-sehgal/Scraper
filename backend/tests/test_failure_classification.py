...
class TestErrorClassification:
    ...
    def test_classify_timeout_with_low_dom_nodes(self):
    ...
    def test_classify_error_with_similar_keywords(self):
...
class TestHttpStatusCodeClassification:
    ...
    def test_forbidden_with_challenge(self):
    ...
    def test_forbidden_without_challenge(self):
    ...
    def test_status_code_200_should_not_classify(self):
...
class TestHtmlClassification:
    ...
    def test_challenge_with_low_anti_bot_score(self):
    ...
    def test_well_formed_html_should_not_classify_as_malformed(self):
    ...
    def test_lazy_load_with_low_dom(self):
...
class TestExtractionResultClassification:
    ...
    def test_no_records_from_discovery(self):
        result = classify_failure(
            extraction_result={
                "method": "discovery",
                "records": [],
    ...
    def test_no_records_generic(self):
        result = classify_failure(
            extraction_result={
                "method": "regex",
                "records": [],
...
class TestTelemetryAndDomainClassification:
    ...
    def test_low_anti_bot_no_html(self):
        result = classify_failure(
            telemetry={"anti_bot_score": 0.3},
        )
        assert result.category == FailureCategory.UNKNOWN

    def test_low_selector_hit_with_fallback(self):
        result = classify_failure(
            telemetry={
    ...
    def test_high_selector_decay_rate(self):
        result = classify_failure(
...
class TestDomainIntelligenceIntegration:
    ...
    def test_repeated_failure_adjusts_strategy(self, mock_domain_intel):
    ...
    def test_repeated_anti_bot_adjusts_strategy(self, mock_domain_intel):
    ...
    def test_repeated_hydration_failure_delays_increase(self, mock_domain_intel):
