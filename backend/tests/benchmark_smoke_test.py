...
SITES: list[SiteTest] = [
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Article title", required=False),
            SchemaField(name="score", field_type=FieldType.INTEGER, required=False, description="Upvotes or points", required=False),
            SchemaField(name="author", field_type=FieldType.STRING, required=False, description="Submitter username", required=False),
        ],
        min_expected=10,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Book title", required=False),
            SchemaField(name="price", field_type=FieldType.CURRENCY, required=False, description="Book price", required=False),
            SchemaField(name="rating", field_type=FieldType.STRING, required=False, description="Star rating", required=False),
        ],
        min_expected=5,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="quote", field_type=FieldType.STRING, required=False, description="Quote text", required=False),
            SchemaField(name="author", field_type=FieldType.STRING, required=False, description="Quote author", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="country", field_type=FieldType.STRING, required=False, description="Country name", required=False),
            SchemaField(name="population", field_type=FieldType.INTEGER, required=False, description="Population", required=False),
            SchemaField(name="yearly_change", field_type=FieldType.STRING, required=False, description="Yearly change %", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="country", field_type=FieldType.STRING, required=False, description="Country name", required=False),
            SchemaField(name="gdp", field_type=FieldType.STRING, required=False, description="GDP in USD", required=False),
        ],
        min_expected=10,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="country", field_type=FieldType.STRING, required=False, description="Country name", required=False),
            SchemaField(name="capital", field_type=FieldType.STRING, required=False, description="Capital city", required=False),
        ],
        min_expected=5,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="team", field_type=FieldType.STRING, required=False, description="Team name", required=False),
            SchemaField(name="wins", field_type=FieldType.INTEGER, required=False, description="Number of wins", required=False),
            SchemaField(name="losses", field_type=FieldType.INTEGER, required=False, description="Number of losses", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Book title", required=False),
            SchemaField(name="author", field_type=FieldType.STRING, required=False, description="Book author", required=False),
            SchemaField(name="year", field_type=FieldType.STRING, required=False, description="Publication year", required=False),
        ],
        min_expected=10,
    ),
    SiteTest(
    ...
    SiteTest(
        ...
        schema=[
            SchemaField(name="heading", field_type=FieldType.STRING, required=False, description="Page heading", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="section", field_type=FieldType.STRING, required=False, description="Section heading", required=False),
            SchemaField(name="paragraph", field_type=FieldType.STRING, required=False, description="Content text", required=False),
        ],
        min_expected=1,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="repo", field_type=FieldType.STRING, required=False, description="Repository name", required=False),
            SchemaField(name="description", field_type=FieldType.STRING, required=False, description="Repo description", required=False),
            SchemaField(name="stars", field_type=FieldType.STRING, required=False, description="Star count", required=False),
        ],
        min_expected=1,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="fact", field_type=FieldType.STRING, required=False, description="Cat fact", required=False),
        ],
        min_expected=1,
    ),
    SiteTest(
    ...
    SiteTest(
        ...
        schema=[
            SchemaField(name="link_text", field_type=FieldType.STRING, required=False, description="Link anchor text", required=False),
            SchemaField(name="link_url", field_type=FieldType.URL, required=False, description="Link destination", required=False),
        ],
        min_expected=0,
    ),
    ...
    SiteTest(
        ...
        schema=[
            SchemaField(name="headline", field_type=FieldType.STRING, required=False, description="News headline", required=False),
            SchemaField(name="timestamp", field_type=FieldType.STRING, required=False, description="Publication time", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="heading", field_type=FieldType.STRING, required=False, description="Page heading", required=False),
            SchemaField(name="paragraph", field_type=FieldType.STRING, required=False, description="Content paragraph", required=False),
        ],
        min_expected=1,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Question title", required=False),
            SchemaField(name="votes", field_type=FieldType.INTEGER, required=False, description="Vote count", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
    ...
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Movie title", required=False),
            SchemaField(name="rating", field_type=FieldType.STRING, required=False, description="IMDb rating", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="headline", field_type=FieldType.STRING, required=False, description="News headline", required=False),
            SchemaField(name="summary", field_type=FieldType.STRING, required=False, description="Article summary", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Recipe title", required=False),
            SchemaField(name="rating", field_type=FieldType.STRING, required=False, description="Recipe rating", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Book title", required=False),
            SchemaField(name="author", field_type=FieldType.STRING, required=False, description="Author name", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="currency", field_type=FieldType.STRING, required=False, description="Currency name", required=False),
            SchemaField(name="rate", field_type=FieldType.STRING, required=False, description="Exchange rate", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="module", field_type=FieldType.STRING, required=False, description="Module name", required=False),
            SchemaField(name="summary", field_type=FieldType.STRING, required=False, description="Module summary", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
        ...
        schema=[
            SchemaField(name="title", field_type=FieldType.STRING, required=False, description="Paper title", required=False),
            SchemaField(name="authors", field_type=FieldType.STRING, required=False, description="Author list", required=False),
        ],
        min_expected=0,
    ),
    SiteTest(
