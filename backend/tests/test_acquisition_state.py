...
class TestAcquisitionState:
    ...
    def test_direct_state(self):
        assert AcquisitionState.DIRECT.value == "direct"

    def test_session_expired_state(self):
...
class TestAcquisitionLineage:
    ...
    def test_direct_lineage_to_dict(self):
    ...
    def test_session_expired_lineage_to_dict(self):
        lineage = AcquisitionLineage(
    ...
    def test_recovered_lineage_to_dict(self):
        lineage = AcquisitionLineage(
            original_url="https://example.com/search/abc123",
    ...
    def test_recovery_failed_lineage_to_dict(self):
        lineage = AcquisitionLineage(
            original_url="https://example.com/search/abc123",
            final_url="https://example.com/",
    ...
    def test_from_redirect_info_no_redirect(self):
        redirect_info = {
            "redirected": False,
            "redirect_type": "none",
            "message": "No redirect detected",
    ...
    def test_from_redirect_info_session_expired_no_recovery(self):
        redirect_info = {
            "redirected": True,
    ...
    def test_from_redirect_info_session_expired_with_successful_recovery(self):
        redirect_info = {
            "redirected": True,
            "redirect_type": "session_expired",
            "message": "URL redirected to homepage — session expired",
    ...
    def test_from_redirect_info_session_expired_awaiting_params(self):
        redirect_info = {
            "redirected": True,
            "redirect_type": "session_expired",
            "message": "URL redirected to homepage — session expired",
    ...
    def test_from_redirect_info_session_expired_no_search_form(self):
        redirect_info = {
            "redirected": True,
            "redirect_type": "session_expired",
            "message": "URL redirected to homepage — session expired",
    ...
    def test_from_redirect_info_recovery_message_in_non_redirected(self):
    ...
    def test_from_redirect_info_path_changed(self):
        redirect_info = {
            "redirected": True,
    ...
    def test_from_redirect_info_homepage_redirect(self):
        redirect_info = {
            "redirected": True,
...
class TestBuildRedirectInfo:
    ...
    def test_session_expired_with_recovery(self):
        initial_redirect = {
            "redirected": True,
            "redirect_type": "session_expired",
            "message": "URL redirected to homepage — session expired",
    ...
    def test_session_expired_no_recovery(self):
        result = build_redirect_info(
