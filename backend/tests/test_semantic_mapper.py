...
class TestDetectSemanticType:
    ...
    def test_price_with_code(self) -> None:
...
class TestIsNoiseValue:
    ...
    def test_short_string_is_noise(self) -> None:
        assert _is_noise_value("a") is True

    def test_common_ui_noise(self) -> None:
...
class TestMatchValuesToIntent:
    ...
    def test_maps_price_to_price_need(self) -> None:
    ...
    def test_maps_date_to_date_need(self) -> None:
    ...
    def test_unmatched_need_falls_back_to_first_value(self) -> None:
