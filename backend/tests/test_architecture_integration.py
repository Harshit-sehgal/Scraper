...
def test_all_14_modules_are_importable():
    ...
    modules = [
        'app.core_types', 'app.topology_state', 'app.energy_state',
        'app.instability_state', 'app.topology_api', 'app.energy_api',
        'app.instability_api', 'app.event_journal', 'app.topology_gc',
        'app.invariant_firewall', 'app.field_validator', 'app.observability',
        'app.field_laws', 'app.persistence_state',
    ]
    for m in modules:
        try:
            __import__(m)
