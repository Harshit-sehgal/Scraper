...
_ALIAS_MAP: dict[str, list[str]] = {
    ...
    "price": ["price", "cost", "amount", "total", "fare", "rate", "fee", "charge", "value"],
    ...
    "time": ["time", "start_time", "end_time", "duration", "travel_time"],
    ...
    "origin": ["origin", "from", "source", "departure", "departure_airport", "departure_code"],
    "destination": ["destination", "to", "target", "arrival", "arrival_airport", "arrival_code"],
    "carrier": ["carrier", "airline", "transport", "operator", "provider", "vendor"],
    "flight_number": ["flight_number", "flight_no", "flight", "route_code", "train_number"],
