...
def calculate_extraction_accuracy(
    ...
    # Precision is based on all comparable extracted fields, including fields in
    # unmatched extra records. Recall is based on expected fields. This avoids
    # reporting perfect precision when the scraper returns the expected records
    # plus noisy or duplicate data.
