...
def evolve_all(state: "TopologyState", force: bool = False) -> list[Any]:
...
def propagate_all(state: "TopologyState") -> list[Any]:
...
def redistribute_instability(state: "TopologyState", damping: float = 1.0) -> dict[str, Any]:
