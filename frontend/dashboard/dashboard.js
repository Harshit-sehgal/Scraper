...
(function () {
  ...
  const UPDATE_INTERVAL =
    typeof window.DATAFORGE_DASHBOARD_INTERVAL === "number" ? window.DATAFORGE_DASHBOARD_INTERVAL : 2000;
  const MAX_INTERVAL =
    typeof window.DATAFORGE_DASHBOARD_MAX_INTERVAL === "number" ? window.DATAFORGE_DASHBOARD_MAX_INTERVAL : 30000;
  ...
  function initCharts() {
    ...
    communityChart = new Chart(communityCtx, {
      ...
      data: {
        labels: [],
        datasets: [{ label: "Roles", data: [], backgroundColor: "#22c55e" }],
      },
      options: chartDefaults(),
    });
  }
            ...
            : e.type === "transaction"
              ...
              : e.type === "wave_absorption"
                ...
                : e.type === "scrape"
                  ...
                  : "text-gray-500";
        const icon =
          e.type === "degradation" ? "⚠" : e.type === "wave_absorption" ? "⌇" : e.type === "scrape" ? "⚓" : "◈";
