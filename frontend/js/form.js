...
export async function submitJob(e) {
    ...
    const payload = {
        ...
        origin_location: originLocation, max_distance_km: maxDistance,
        source_policy: sourcePolicy, max_per_domain: maxPerDomain,
        schema_fields: schema, filters, selectors_map: selectorsMap,
        ...
        max_pages: maxPages, min_record_score: minScore,
    };
