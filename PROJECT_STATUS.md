...
| Frontend vitest suite                                                      | `267 passed (267) — 14 files`                | All unit tests pass — 5 dashboard modules (48 tests) + 35 utils.js tests + 10 edge cases + 20 cognition.js + 18 analyzer.js + 17 form.js + 20 jobs.js + 17 results.js tests |
...
| Frontend results.js test coverage                                          | `17 new tests across 3 describe blocks`      | renderLogs (sorting, level CSS, timestamp filter, XSS), applyResultSearch, renderTable (columns, null->em dash, key skipping)                                               |
