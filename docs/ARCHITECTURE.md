...
| Extraction | `backend/app/extraction_orchestrator.py`, `backend/app/selector_engine.py`, `backend/app/network_extractor.py`, `backend/app/container_discovery.py`, `backend/app/rendered_visible_text_extractor.py` | Schema, selector, network payload, text fallback extraction | Core | Unit/API/browser tests | Real-world accuracy not proven | Keep, add benchmarks |
