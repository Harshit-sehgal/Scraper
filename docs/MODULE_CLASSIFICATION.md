...
| `app.postgres_repository` | Core | Postgres storage backend | Optional tests | Postgres `1883 passed` and Compose smoke | Production migrations/backups unvalidated | Keep |
