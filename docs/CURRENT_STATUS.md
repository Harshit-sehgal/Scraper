...
**Generated:** 2026-06-17 18:38:10 UTC
...
| Gate | Status |
| --- | --- |
| Test collection | 3774 tests collected, exit 0 |
| DNS isolation | URL safety tests pass in <1s (was hanging) |
| Stable API docs | 98 routes (vs 133 with experimental: 35 diff) |
...
| Check | Status |
| --- | --- |
| CSS syntax (stylelint) | ❌ fail |
| JS/JSON format (prettier) | ❌ fail |
| Frontend unit tests (vitest) | ❌ fail |
...
---
_Generated by `scripts/generate_status.py` at 2026-06-17 18:38:10 UTC_
