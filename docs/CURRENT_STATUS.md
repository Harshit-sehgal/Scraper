...
**Generated:** 2026-06-11 18:06:10 UTC
...
| Gate | Status |
| --- | --- |
| Test collection | 3407 tests collected, exit 0 |
| DNS isolation | URL safety tests pass in <1s (was hanging) |
| Stable API docs | 50 routes (vs 85 with experimental: 35 diff) |
...
---
_Generated by `scripts/generate_status.py` at 2026-06-11 18:06:10 UTC_
