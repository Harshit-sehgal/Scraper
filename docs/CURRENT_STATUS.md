...
**Generated:** 2026-06-19 21:01:56 UTC
...
| Gate | Status |
| --- | --- |
| Test collection | 3812 tests collected, exit 0 |
| DNS isolation | URL safety tests pass in <1s (was hanging) |
| Stable API docs | 99 routes (vs 134 with experimental: 35 diff) |
...
---
_Generated by `scripts/generate_status.py` at 2026-06-19 21:01:56 UTC_
